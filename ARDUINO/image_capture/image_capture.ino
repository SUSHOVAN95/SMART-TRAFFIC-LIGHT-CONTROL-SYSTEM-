...
const struct regval_list yuv422_ov7670[] PROGMEM = {
  { REG_COM7, 0 },  /* Selects YUV mode 0x0 */
  { REG_RGB444, R444_ENABLE },  /* No RGB444 please 0*/
  { REG_COM1, 0 },
  { REG_COM15, COM15_R00FF },
  { REG_COM9, 0x38 }, /* 128x gain ceiling; 0x8 is reserved bit */
...
const struct regval_list ov7670_default_regs[] PROGMEM = {//from the linux driver
  ...
  */
  ...
  { REG_VSTOP, 0 }, { REG_VREF, 0x0a },

  { REG_COM3, 0x08 }, { REG_COM14, 0 },
...
void arduinoUnoInut(void) {
  ...
  * This will be on pin 11*/
  ...
  _delay_ms(3000); //changed it 3000
